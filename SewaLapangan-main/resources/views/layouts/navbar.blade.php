        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            @if (Auth::check())
                <ul class="nav nav-pills black d-flex gap-3">
                    ...
                    <li class="nav-item col-2 col-md-auto"><a href="{{ route('admin.reqsewa') }}"
                            class="nav-link @if ($currentRouteName == 'reqsewa') active @endif">Request Sewa</a></li>
                    <li class="nav-item col-2 col-md-auto"><a href="{{ route('admin.accsewa') }}"
            ...
            @else
                <ul class="nav nav-pills black d-flex gap-3">
                    ...
                    <li class="nav-item col-2 col-md-auto"><a href="{{ route('login') }}"
                            class="nav-link @if ($currentRouteName == 'login') active @endif">Login</a></li>
                </ul>
            @endif
