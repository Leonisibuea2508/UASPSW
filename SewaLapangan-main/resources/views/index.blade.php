...
@section('content')
    <div class="px-4 py-4 my-5 text-center">
        <img class="d-block mx-auto mb-4" src="{{ Vite::asset('resources/images/deportes.jpg') }}" alt="" width="162"
            height="126">
        <h1 class="display-5 fw-bold">Pardonganan</h1>
        <div class="col-lg-6 mx-auto">
            <p class="lead mb-4">Platform terpercaya bagi anda untuk menyewa lapangan yang anda butuhkan! Khususnya lapangan badminton. Tersedia di
                berbagai tempat dan wilayah, semua ada di PARDONGANAN!</p>
    ...
    <div class="container col-xxl-8 px-4">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            ...
            <div class="col-lg-6">
                ...
                <p class="display-6">Booking aja lapangannya di PARDONGANANs!</p>
